...
[![Tests](https://github.com/openedx-actions/tutor-k8s-configure-edx-admin/actions/workflows/testRelease.yml/badge.svg)](https://github.com/openedx-actions/tutor-k8s-configure-edx-admin/actions)
  ...
  build:
    ...
    steps:
      ...
      - name: Create admin user
        uses: openedx-actions/tutor-k8s-configure-edx-admin@v1.0.3
```
